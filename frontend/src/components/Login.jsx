  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-[var(--font-body)]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 relative">
        ...
        <div className="z-10 w-full max-w-3xl space-y-8 flex flex-col items-center">
          {/* Main Headings */}
          ...
          <div className="flex gap-6 items-start">
              ...
              <div className="flex-1 p-8 sm:p-10 flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 border-[2px] border-black p-1 bg-gray-50">
                  <button
                    ...
                    className={`py-3 text-[10px] font-black tracking-[0.15em] uppercase transition-all ${role === 'student'
                  ...
                  <button
                    ...
                    className={`py-3 text-[10px] font-black tracking-[0.15em] uppercase transition-all ${role === 'admin'
                      ? 'bg-primary border-2 border-black text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]'
                      : 'text-gray-500 hover:text-black'
                      }`}
                  >
            ...
            {/* Judge Quick Access - Side Panel */}
            <div className="w-[220px] bg-amber-50 border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-md p-5 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-[10px] font-black tracking-[0.15em] uppercase text-amber-700">⚡ JUDGE ACCESS</span>
              </div>
              <div className="space-y-2 mb-5">
                <div>
                  <span className="text-[9px] font-bold tracking-wider text-gray-500 uppercase block mb-0.5">Email</span>
                  <span className="text-[11px] font-mono font-bold text-black break-all leading-tight">gorulesaravk13@gmail.com</span>
                </div>
                <div>
                  <span className="text-[9px] font-bold tracking-wider text-gray-500 uppercase block mb-0.5">Password</span>
                  <span className="text-[11px] font-mono font-bold text-black">saragorulea46</span>
                </div>
              </div>
              <button
                type="button"
                onClick={() => {
                  setEmail('gorulesaravk13@gmail.com');
                  setPassword('saragorulea46');
                }}
                className="w-full bg-amber-400 border-2 border-black text-black text-[9px] font-black tracking-[0.15em] uppercase py-2.5 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] transition-all"
              >
                AUTO-FILL
              </button>
            </div>
